...
export function EditTaskScreen({ navigation, route }: EditTaskScreenProps) {
  ...
  const initialData: Partial<TaskFormData> = {
    ...
    reminderSoundId: task.reminderSoundId ?? null,
    triggerType: task.triggerType,
    firstUnlockWindow: task.firstUnlockWindow ?? null,
    dismissAction: task.dismissAction,
    nagInterval: task.nagInterval,
    locationNote: task.locationNote ?? '',
